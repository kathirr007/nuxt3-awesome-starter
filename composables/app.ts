  ...
  const social = [
    {
      ...
      iconUrl:
        'https://res.cloudinary.com/nuxt-kathir-bnb/image/upload/v1672162127/test/facebook_kvtqbj.png',
    ...
    },
    {
      ...
      iconUrl:
        'https://res.cloudinary.com/nuxt-kathir-bnb/image/upload/v1672162128/test/twitter_ha7opo.png',
      /* icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
    ...
    },
    {
      ...
      iconUrl:
        'https://res.cloudinary.com/nuxt-kathir-bnb/image/upload/v1672162128/test/youtube_ooflru.png',
      /* icon: defineComponent({
        render: () =>
...
export const userContactForm = createGlobalState(() => {
  return ref()
})
