  ...
  <div class="bg-white">
    <Popover as="header" class="relative">
      <div class="bg-warm-gray-50">
        <nav
          class="relative mx-auto flex max-w-7xl items-center justify-between px-6 pt-6 xl:px-8"
          aria-label="Global"
        >
          <div class="flex flex-1 items-center">
            <div class="flex w-full items-center justify-between lg:w-auto">
              ...
              <div class="-mr-2 flex items-center lg:hidden">
                <PopoverButton
                  class="focus-ring-inset inline-flex items-center justify-center rounded-md bg-warm-gray-50 p-2 text-warm-gray-400 hover:bg-warm-gray-100 focus:outline-none focus:ring-2 focus:ring-teal-500"
                >
          ...
          <div class="hidden lg:flex lg:items-center lg:space-x-6">
            <a
              href="#"
              class="rounded-md border border-transparent bg-warm-gray-100 py-2 px-6 text-base font-medium text-warm-gray-900 hover:bg-warm-gray-200"
              >Login</a
            >
          </div>
        </nav>
        ...
        >
          ...
          >
            <div class="flex items-center justify-between px-5 pt-4">
              ...
              <div class="-mr-2">
                <PopoverButton
                  class="inline-flex items-center justify-center rounded-md bg-white p-2 text-warm-gray-400 hover:bg-warm-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500"
                >
            ...
            <div class="pt-5 pb-6">
              <div class="space-y-1 px-2">
                <a
                  ...
                  :key="item.name"
                  :href="item.href"
                  class="block rounded-md px-3 py-2 text-base font-medium text-warm-gray-900 hover:bg-warm-gray-50"
                  >{{ item.name }}</a
                >
              </div>
              <div class="mt-6 px-5">
                <a
                  href="#"
                  class="block w-full rounded-md border border-transparent bg-teal-500 py-2 px-4 text-center font-medium text-white shadow hover:bg-teal-600"
                  >Login</a
                >
              </div>
            </div>
    ...
    <main class="overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
              <!-- Contact information -->
              <div
                class="relative overflow-hidden bg-gradient-to-b from-teal-500 to-teal-600 py-10 px-6 sm:px-10 xl:p-12"
              >
      ...
      <section aria-labelledby="offices-heading">
        <div class="mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h2
            id="offices-heading"
            class="text-3xl font-bold tracking-tight text-warm-gray-900"
          >
            Our offices
          </h2>
          <p class="mt-6 max-w-3xl text-lg text-warm-gray-500">
            Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate
            id malesuada non. Cras aliquet purus dui laoreet diam sed lacus,
            fames.
          </p>
          <div
            class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4"
          >
        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            <img
              ...
              alt="Company name"
            />
            <p class="text-base text-warm-gray-400">
          ...
          <div class="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-base font-medium text-warm-gray-200">
                  Solutions
                </h3>
